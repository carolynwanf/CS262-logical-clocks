...
void clockThread(int queueID) {
    std::string filename = "machine"+std::to_string(queueID)+"log.csv";
    ...
    while(g_programRunning) {
        ...
        if (clockVal_queueLength.first != -1) {
            filewriter << std::to_string(false) << ", " << std::to_string(false) << ", " << std::to_string(true) 
                        << ", " << systemTimeString << ", " << std::to_string(clockTime) << ", " << clockVal_queueLength.second << std::endl;
        ...
        case SEND_MESSAGE_TO_ONE:
            {
                ...
                filewriter << std::to_string(true) << ", " << std::to_string(false) << ", " << systemTimeString
        ...
        default:
            filewriter << std::to_string(false) << ", " << std::to_string(false) << ", " << systemTimeString
                        << ", " << std::to_string(clockTime) << ", " << std::to_string(clockVal_queueLength.second) << std::endl;
            clockTime++;
            break;
        }
